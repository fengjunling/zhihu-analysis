...
<link rel="stylesheet" href="vendor/bootstrap/css/bootstrap.min.css"
	tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/bootstrap/css/bootstrap.min.css">
<!-- Font Awesome CSS-->
<link rel="stylesheet"
	href="vendor/font-awesome/css/font-awesome.min.css"
	tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/font-awesome/css/font-awesome.min.css">
<!-- Fontastic Custom icon font-->
<link rel="stylesheet" href="css/fontastic.css"
	tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/css/fontastic.css">
<!-- Google fonts - Poppins -->
<link rel="stylesheet"
	href="../../../../../fonts.googleapis.com/css-family=Poppins-300,400,700"
	tppabs="https://fonts.googleapis.com/css?family=Poppins:300,400,700">
<!-- theme stylesheet-->
<link rel="stylesheet" href="css/style.default.css"
	tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/css/style.default.css"
	id="theme-stylesheet">
<!-- Custom stylesheet - for your changes-->
<link rel="stylesheet" href="css/custom.css"
	tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/css/custom.css">
<!-- Favicon-->
<link rel="shortcut icon" href="img/favicon.ico"
	tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/favicon.ico">
...
<body>
				...
				<div class="container-fluid">
					<div
						...
						<div class="navbar-header">
							<!-- Navbar Brand -->
							<a href="index.html"
								tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/index.html"
								class="navbar-brand d-none d-sm-inline-block">
								<div class="brand-text d-none d-lg-inline-block">
									<strong>知乎网数据分析</strong>
								</div>
		...
		<div class="page-content d-flex align-items-stretch">
			...
			<nav class="side-navbar">
				...
				<div class="sidebar-header d-flex align-items-center">
					<div class="avatar">
						<img src="img/liukanshan2.jpg" alt="..."
				...
				<ul class="list-unstyled">
					...
					<li><a href="charts.html"> </i>Charts
					</a></li>
					...
					<div class="container-fluid">
						<div class="row bg-white has-shadow">
							...
							<div class="col-xl-3 col-sm-6">
								<div class="item d-flex align-items-center">
									<div class="title">
										<span>Topic<br>BestAnswersGt1000
										</span>
										<div class="progress">
									...
									<div class="project-title d-flex align-items-center">
										<div class="image has-shadow">
											<img src="img/project-1.jpg"
												tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/project-1.jpg"
												alt="..." class="img-fluid">
										</div>
										<div class="text">
									...
									<div class="project-title d-flex align-items-center">
										<div class="image has-shadow">
											<img src="img/project-2.jpg"
												tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/project-2.jpg"
												alt="..." class="img-fluid">
										</div>
										<div class="text">
											<h3 class="h4">Project Title</h3>
									...
									<div class="project-title d-flex align-items-center">
										<div class="image has-shadow">
											<img src="img/project-3.jpg"
												tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/project-3.jpg"
												alt="..." class="img-fluid">
										</div>
										<div class="text">
											<h3 class="h4">Project Title</h3>
									...
									<div class="project-title d-flex align-items-center">
										<div class="image has-shadow">
											<img src="img/project-4.jpg"
												tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/project-4.jpg"
												alt="..." class="img-fluid">
										</div>
										<div class="text">
											<h3 class="h4">Project Title</h3>
									...
									<div class="card-body text-center">
										<div class="client-avatar">
											<img src="img/avatar-2.jpg"
												tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/avatar-2.jpg"
							...
							<div class="col-lg-6">
								<div class="articles card">
									...
									<div class="card-body no-padding">
										<div class="item d-flex align-items-center">
											<div class="image">
												<img src="img/avatar-1.jpg"
													tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/avatar-1.jpg"
													alt="..." class="img-fluid rounded-circle">
											</div>
											<div class="text">
												<a href="#">
										...
										<div class="item d-flex align-items-center">
											<div class="image">
												<img src="img/avatar-3.jpg"
													tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/avatar-3.jpg"
													alt="..." class="img-fluid rounded-circle">
											</div>
											<div class="text">
												<a href="#">
										...
										<div class="item d-flex align-items-center">
											<div class="image">
												<img src="img/avatar-4.jpg"
													tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/avatar-4.jpg"
													alt="..." class="img-fluid rounded-circle">
											</div>
											<div class="text">
												<a href="#">
										...
										<div class="item d-flex align-items-center">
											<div class="image">
												<img src="img/avatar-5.jpg"
													tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/img/avatar-5.jpg"
													alt="..." class="img-fluid rounded-circle">
											</div>
											<div class="text">
												<a href="#">
							...
							<div class="col-sm-6">
								<p>
									Copyright &copy; 2019.Company name All rights reserved. <a
										target="_blank"
										href="javascript:if(confirm('http://www.17sucai.com/  \n\n�ļ���δ�� Teleport Pro ȡ�أ���Ϊ ������·������ʼ��ַ�����õķ�Χ��  \n\n��Ҫ�ӷ������ϴ�����'))window.location='http://www.17sucai.com/'"
										tppabs="http://www.17sucai.com/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a>
								</p>
							</div>
	...
	<script src="vendor/jquery/jquery.min.js"
		tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/jquery/jquery.min.js"></script>
	<script src="vendor/popper.js/umd/popper.min.js"
		tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/popper.js/umd/popper.min.js">
		
	</script>
	<script src="vendor/bootstrap/js/bootstrap.min.js"
		tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/bootstrap/js/bootstrap.min.js"></script>
	<script src="vendor/jquery.cookie/jquery.cookie.js"
		tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/jquery.cookie/jquery.cookie.js">
		
	</script>

	<script src="vendor/chart.js/Chart.min.js"
		tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/chart.js/Chart.min.js"></script>
	<script src="vendor/jquery-validation/jquery.validate.min.js"
		tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/vendor/jquery-validation/jquery.validate.min.js"></script>
	<!-- Main File-->
	<script src="js/front.js"
		tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/js/front.js"></script>
	<script type="text/javascript">
		var topicnames = ${namesT};
		var followersT = ${followersT};
		var usernames = ${namesU};
		var followersU = ${followersU}; 
	</script>
	<script src="js/charts-home.js" tppabs="http://www.17sucai.com/preview/1528155/2019-02-11/3492/js/charts-home.js"></script>
</body>
